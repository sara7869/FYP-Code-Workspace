...
export class LandingPageComponent implements OnInit {
  ...
  attritionFactors = [
    ...
    { factor: 'Business Travel', correlation: +0.000074, color: 'red' },
    { factor: 'Distance From Home', correlation: +0.078, color: 'red' },
    { factor: 'Stock Option Level', correlation: -0.14, color: 'green' },
  ];
